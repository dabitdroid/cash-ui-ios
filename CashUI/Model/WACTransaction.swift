...
public struct WACTransaction: CustomStringConvertible, Codable, Equatable {
    ...
    public var status: WACTransactionStatus
    ...
    public init(status: WACTransactionStatus, atm: AtmMachine? = nil, code: CashCode? = nil) {
...
extension WACTransaction {
    static func hasUniqueIdentifier(_ transaction: WACTransaction) -> Bool {
